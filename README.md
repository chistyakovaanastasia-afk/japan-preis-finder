...
| **Suche** | Suchfeld über der Liste: filtert über Produktname, „Was/wofür“, „Für wen“ und Notiz. Groß-/Kleinschreibung, Akzente und Umlaut-Schreibweisen sind egal (`Süßigkeit` = `suessigkeit` = `sussigkeit`), mehrere Wörter werden UND-verknüpft. Lässt sich mit dem Personenfilter kombinieren. |
...
| **Neue Personen/Kategorien** | Einfach ins Feld schreiben. Jeder vergebene Wert steht danach automatisch als Vorschlag (`<datalist>`) und als Filterchip zur Verfügung — die Startvorschläge (Ich, Mami, Papi, Grossi, Geschenk) sind nur der Anfang. |
